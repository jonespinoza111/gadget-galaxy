...
<div>
    <div class="w-full flex flex-col py-5 px-8 justify-center">
        <div>
            ...
            @endif
            <div>
                <div class="card-header flex flex-row justify-between items-center mb-4">
                        ...
                        <tbody>
                            @forelse ($users as $user)
                                <tr class="">
                                    ...
                                    <td>
                                        <a href="{{ url('admin/users/'.$user->id.'/edit') }}" class="w-[150px] px-5 py-2 bg-blue-400 hover:bg-blue-500">Edit</a>
