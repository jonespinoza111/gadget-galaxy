...
@section("content")
<div class="container custom-product flex flex-col h-auto w-[100%] min-h-screen">
    <div class="w-full mx-6 mt-6">
        <h2 class="text-[1.5em] font-semibold">Our Products</h2>
    </div>
    {{-- <div class="flex flex-row flex-wrap w-[100%] h-auto mx-6 my-3 gap-3">
