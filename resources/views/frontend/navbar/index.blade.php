...
<div class="px-5 xl:px-12 py-6 flex w-full items-center justify-between">
        ...
        <div id="dropdown" class="hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 z-40">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
              @if(Session::has('user'))
                ...
                <li>
                    <a href="/wishlist" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Wishlists</a>
                </li>
                <li>
    ...
    <button data-collapse-toggle="navbar-hamburger" type="button" class="md:hidden inline-flex items-center z-30 justify-center p-2 w-10 h-10 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-hamburger" aria-expanded="false">
...
{{-- <div class="flex flex-row items-center"> --}}
    ...
    <div class="hidden w-full" id="navbar-hamburger">
        ...
        <li>
            <a href="/home" class="block py-2 pl-3 pr-4 text-white bg-blue-700  dark:bg-blue-600" aria-current="page">Home</a>
        </li>
        <li>
        ...
        <li>
            <a href="/wishlist" class="block py-2 pl-3 pr-4 text-gray-900  hover:bg-gray-100 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white">Wishlists</a>
        </li>
        <li>
