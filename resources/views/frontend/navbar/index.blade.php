...
<div class="px-5 xl:px-12 py-6 flex w-full items-center justify-between">
    ...
    <form class="space-x-12 w-[60%]" action="{{ url('search') }}" method="GET">   
    ...
    <div class="relative inline-block text-left">
        ...
        <!-- Dropdown menu -->
        <div id="dropdown" class="hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 z-100">
